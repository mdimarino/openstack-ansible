...
neutron subnet-create --name provider --allocation-pool start=192.168.56.101,end=192.168.56.250 --dns-nameserver 8.8.4.4 --gateway 192.168.56.254 provider 192.168.56.0/24
. ./demo-openrc
